...
if ($a.Path -notlike "*Version=`"12.1.671.4971`"") {
    & 'C:\Program Files\Symantec\Symantec Endpoint Protection\Smc.exe' -stop -p adminPassword
    sleep 5
...
ELSE {write-host "The newest version of SEP is already installed. Exiting..." -Fore Green}